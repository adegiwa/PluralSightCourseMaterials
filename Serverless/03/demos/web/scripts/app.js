...
function loadEventDetails(eventId, responseCode) {
    /*var getEventDetailsUrl = 'https://whosplaying.azurewebsites.net/api/event/' 
                                + eventId + '?responseCode=' + responseCode;*/
    var getEventDetailsUrl = "scripts/data.js";
...
function respond(e) {
    ...
    var updateResponseUrl = 'https://whosplaying.azurewebsites.net/api/events/' 
